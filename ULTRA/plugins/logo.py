# Ultra X - UserBot
# Copyright (C) 2021 Ultra X 
#
# This file is a part of < https://github.com/ULTRA-OP/ULTRA-X/ >
# PLease read the GNU Affero General Public License in
# <https://github.com/ULTRA-OP/ULTRA-X/blob/main/LICENSE>.
...
async def logo_gen(event):
    ...
    if event.reply_to_msg_id:
        ...
        async for i in ultroid.iter_messages(
            "@UltraxLogos", filter=InputMessagesFilterPhotos
        ):
            pics.append(i)
